...
public class BlogsController {
    ...
    public List<BlogsEntity> getBlogsByCate(@RequestParam(name = "CategoryID") Integer categoryID,
        ...
        return blogsService.getBlogsByCate(categoryID, orderBy, pageNum);
    }
...
//    public List<BlogsEntity> getNews(@RequestParam(name = "orderBy", defaultValue = "timePosting") String orderBy,
//                                    @RequestParam(name = "pageNum", defaultValue = "0") Integer pageNum){
//        return blogsService.getBlogEntities("ACTIVE",orderBy, pageNum);
//    }
